...
public class UserInfoResponse {
    public static final Logger log = LogManager.getLogger(UserInfoResponse.class);

    public void getResponeData(String userid,String urn,CommonApiResponseModal responseModal) {
        try {
            ...
            wadProcObj.setProcedureName(ProcedureName.GETUSERDATA.procedureName);
            wadProcObj.setTotalData(1);
            wadProcObj.setData(1, userid);
